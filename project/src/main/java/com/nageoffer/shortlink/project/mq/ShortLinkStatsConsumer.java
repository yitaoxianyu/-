...
public class ShortLinkStatsConsumer implements StreamListener<String,MapRecord<String,String,String>> {
    ...
    public void onMessage(MapRecord<String,String,String> message) {
        ...
        String gid = value.get("gid");
        String fullShortUrl = value.get("fullShortUrl");
        ShortLinkStatsRecordDTO shortLinkStatsRecordDTO = JSONObject.parseObject(value.get("shortLinkStatsRecordDTO"), new TypeReference<>() {});
        try { //填充 fullShortUrl
...
//            shortLinkService.update().setSql("total_pv = total_pv + 1")
