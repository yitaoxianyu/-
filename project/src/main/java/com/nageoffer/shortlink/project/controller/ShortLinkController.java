...
public class ShortLinkController {
    ...
    public Result<ShortLinkCreateRespDTO> createShortLink(@RequestBody ShortLinkCreateReqDTO requestParams){
        return Results.success(shortLinkService.createShortLinkByLock(requestParams));
    }

    @PostMapping("/api/short-link/v1/create/batch")
    public Result<ShortLinkBatchCreateRespDTO> batchCreateShortLink(@RequestBody ShortLinkBatchCreateReqDTO requestParams){
        return Results.success(shortLinkService.batchCreateShortLink(requestParams));
    }
